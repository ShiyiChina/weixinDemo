...
Page({
  ...
  stopSign: function(e) {
    ...
    wx.request({
      url: 'http://localhost:8080/xdq/user/stopKaoqin',
      data: {
        keyid: that.data.keyid,
      },
      method: 'POST',
      header: {
      ...
      success: function(res) {
        ...
        wx.redirectTo({
          url: '../queqinList/queqinList?lessonid=' + that.data.lessonid + '&keyid=' + that.data.keyid+ ''
        })
      },
      fail: function(res) {},
  ...
  onPullDownRefresh: function() { //下拉刷新
    ...
    wx.request({
      url: 'http://localhost:8080/xdq/user/showKaoqinList',
      data: {
